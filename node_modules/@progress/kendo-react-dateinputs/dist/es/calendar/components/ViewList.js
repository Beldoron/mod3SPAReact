...
var ViewList = /** @class */ (function (_super) {
    ...
    ViewList.prototype.componentDidMount = function () {
        if (this.virtualization && this.table) {
            ...
            var viewDate = dateInRange(this.props.focusedDate, this.props.min, this.props.max);
