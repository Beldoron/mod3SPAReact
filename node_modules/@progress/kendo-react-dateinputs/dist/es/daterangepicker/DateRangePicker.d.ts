...
/**
 * Represents the props of the [Kendo UI DateRangePicker component for React]({% slug overview_daterangepicker %}).
 */
...
export declare class DateRangePicker extends React.Component<DateRangePickerProps, DateRangePickerState> {
     ...
     * @hidden
     */
    shouldComponentUpdate(nextProps: DateRangePickerProps, nextState: DateRangePickerState): boolean;
    /**
     * @hidden
     */
