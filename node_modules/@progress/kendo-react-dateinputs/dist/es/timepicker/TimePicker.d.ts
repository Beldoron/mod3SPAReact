...
/**
 * Represents the props of the [Kendo UI TimePicker for React component]({% slug overview_timepicker %}).
 */
...
export declare class TimePicker extends React.Component<TimePickerProps, TimePickerState> implements FormComponent {
     ...
     * @hidden
     */
    shouldComponentUpdate(nextProps: TimePickerProps, nextState: TimePickerState): boolean;
    /**
     * @hidden
     */
