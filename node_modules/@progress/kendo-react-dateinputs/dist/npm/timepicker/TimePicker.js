...
var TimePicker = /** @class */ (function (_super) {
     ...
     * @hidden
     */
    TimePicker.prototype.shouldComponentUpdate = function (nextProps, nextState) {
        var nextValue = this.nextValue(nextProps, nextState);
        var nextShow = this.nextShow(nextProps, nextState);
        return (this.value !== null && nextValue !== null
            ? !kendo_date_math_1.isEqual(this.value, nextValue)
    ...
    TimePicker.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (this._timeSelector && this._timeSelector.element && this.show && !prevProps.show) {
            this._timeSelector.element.focus();
        }
        if (this._dateInput
        ...
        else if (this._wrapper && !this.show) {
            this._wrapper.classList.remove('k-state-focused');
        }
