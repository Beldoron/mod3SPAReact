...
var ViewList = /** @class */ (function (_super) {
    ...
    function ViewList(props) {
        ...
        _this.buildMonthView = function (cols, weekNames) {
            return (React.createElement("table", { className: "k-calendar-weekdays" },
    ...
    ViewList.prototype.componentDidMount = function () {
        if (this.virtualization && this.table) {
            this.table.style.transform = "translateY(" + this.viewOffset + "px)";
            var viewDate = utils_1.dateInRange(this.props.focusedDate, this.props.min, this.props.max);
            var indexToScroll = this.props.service.skip(viewDate, this.props.min);
    ...
    ViewList.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: function (el) { _this._element = el; }, className: rootClassNames },
            React.createElement(Header_1.Header, { currentDate: activeDate, min: this.props.min, max: this.props.max, activeView: this.props.activeView, onTodayClick: this.handleTodayClick, bus: this.props.bus, service: this.props.service }),
            this.props.activeView === models_1.CalendarViewEnum.month && this.buildMonthView(cols, this.weekNames),
            React.createElement(Virtualization_1.Virtualization, { ref: function (el) { _this.virtualization = el; }, skip: skip, take: this.take, total: total, itemHeight: this.viewHeight, topOffset: this.viewOffset, bottomOffset: this.bottomOffset, scrollOffsetSize: this.viewOffset, maxScrollDifference: this.viewHeight, onScrollAction: this.handleScrollAction, children: dates })));
    };
    ViewList.propTypes = {
