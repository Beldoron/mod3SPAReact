...
var DateRangePicker = /** @class */ (function (_super) {
     ...
     * @hidden
     */
    DateRangePicker.prototype.shouldComponentUpdate = function (nextProps, nextState) {
        var nextValue = this.calculateValue(nextProps, nextState);
        var nextShow = this.calculateShow(nextProps, nextState);
        return (this.value.start !== null && this.value.end !== null && nextValue.start !== null && nextValue.end !== null
            ? !kendo_date_math_1.isEqualDate(this.value.start, nextValue.start) || !kendo_date_math_1.isEqualDate(this.value.end, nextValue.end)
