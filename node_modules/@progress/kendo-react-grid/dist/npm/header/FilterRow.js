...
var GridFilterCell_1 = require("../filter/GridFilterCell");
/**
 *
 * @hidden
 */
var FilterRow = /** @class */ (function (_super) {
    ...
    FilterRow.prototype.render = function () {
        ...
        var activeFilterValueFor = function (field) {
        ...
        var filterCells = this.props.columns.filter(function (c) { return c.children.length === 0; })
            .map(function (column, index) { return column.filterable && (React.createElement("th", { key: index, className: _this.headerCellClassName(column.field) }, (filterCellProps = {
            render: _this.props.cellRender,
            field: column.field,
            value: activeFilterValueFor(column.field),
            ...
            React.createElement(GridFilterCell_1.GridFilterCell, __assign({}, filterCellProps)))) || React.createElement("th", { key: index }); });
