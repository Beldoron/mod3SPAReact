...
var HeaderRow = /** @class */ (function (_super) {
    ...
    function HeaderRow(props) {
        ...
        _this._element = null;
        _this.cells = function (rowIndex) { return rowIndex.map(function (columnIndex, index) {
            var column = _this.props.columns[columnIndex];
            var sort = _this.props.sortable && column.sortable;
            var sortIcon = sort && _this.sortIcon(column.field);
            var headerCellProps = {
                field: column.field,
            ...
            return (React.createElement("th", { key: index, colSpan: column.colSpan, rowSpan: column.rowSpan, className: className }, [
                column.headerCell &&
                    React.createElement(column.headerCell, __assign({ key: 0 }, headerCellProps), sortIcon) ||
                    React.createElement(GridHeaderCell_1.GridHeaderCell, __assign({ key: 0 }, headerCellProps), sortIcon),
                _this.props.columnResize && _this.props.columnResize.resizable && column.resizable &&
                    React.createElement(ColumnResizer_1.ColumnResizer, { key: 1, resize: function (e, element, end) {
    ...
    HeaderRow.prototype.render = function () {
        var _this = this;
        return this.props.columnsMap.map(function (rowIndex, i) {
            return _this.props.pressHandler && (React.createElement(ColumnDraggable_1.ColumnDraggable, { key: i, pressHandler: _this.props.pressHandler, dragHandler: _this.props.dragHandler, releaseHandler: _this.props.releaseHandler }, _this.cells(rowIndex))) || React.createElement("tr", null, _this.cells(rowIndex));
        });
    };
    return HeaderRow;
}(React.Component));
