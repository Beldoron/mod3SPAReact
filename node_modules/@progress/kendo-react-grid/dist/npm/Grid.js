...
/**
 * Represents the [Kendo UI component for React]({% slug overview_grid %}).
 *
 * @example
 * ```jsx
...
var Grid = /** @class */ (function (_super) {
    ...
    Grid.prototype.render = function () {
        ...
        this.initColumns(children.filter(function (child) { return child && child.type === GridColumn_1.GridColumn; }));
        var toolbar = children.filter(function (child) { return child && child.type === GridToolbar_1.GridToolbar; });
        var noRecords = children.filter(function (child) { return child && child.type === GridNoRecords_1.GridNoRecords; });
        ...
        var data = [];
        index_1.flatData(data, propsData, (this.props.group || []).length, footer, this.props.expandField);
        var hiddenRows = 0;
            ...
            return [(React.createElement(GridRow_1.GridRow, { key: absoluteIndex(index) * 2, dataItem: item.dataItem, isAltRow: isAlt, rowType: item.rowType, isHidden: hidden(index), onClick: function (e) { return _this.rowClick(e, item); }, selectedField: _this.props.selectedField, rowHeight: _this.props.rowHeight, render: _this.props.rowRender }, dataRow(item))),
                _this.props.detail && item.rowType === 'data' && item.expanded && (React.createElement("tr", { key: absoluteIndex(index) * 2 + 1, className: isAlt ? 'k-detail-row k-alt' : 'k-detail-row', style: { visibility: hidden(index) ? 'hidden' : '' } },
                    _this.props.group && _this.props.group.map(function (group, idx) {
                        return React.createElement(GridGroupCell_1.GridGroupCell, { field: group.field, dataItem: item.dataItem, key: idx });
                    }),
    ...
    Grid.prototype.initColumns = function (columnElements) {
        var _this = this;
        ...
        var groupCount = this.props.group ? this.props.group.length : 0;
