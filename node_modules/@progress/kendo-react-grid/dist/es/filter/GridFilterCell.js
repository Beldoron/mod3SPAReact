    ...
    GridFilterCell.prototype.filterComponent = function (filterType, value, localizationService) {
        ...
        switch (filterType) {
            ...
            case 'boolean':
                ...
                return (React.createElement(DropDownList, { onChange: this.boolDropdownChange, value: data.find(function (item) { return item.operator === (value === null ? '' : value); }), data: data, textField: "text" }));
