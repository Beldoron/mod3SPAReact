...
var HeaderRow = /** @class */ (function (_super) {
        ...
        _this.cells = function (rowIndex) { return rowIndex.map(function (columnIndex, index) {
            ...
            return (React.createElement("th", { key: index, colSpan: column.colSpan, rowSpan: column.rowSpan, className: className }, [
                column.headerCell &&
                    ...
                    React.createElement(GridHeaderCell, __assign({ key: 0 }, headerCellProps), sortIcon),
                _this.props.columnResize && _this.props.columnResize.resizable && column.resizable &&
                    React.createElement(ColumnResizer, { key: 1, resize: function (e, element, end) {
    ...
    HeaderRow.prototype.render = function () {
        ...
        return this.props.columnsMap.map(function (rowIndex, i) {
            return _this.props.pressHandler && (React.createElement(ColumnDraggable, { key: i, pressHandler: _this.props.pressHandler, dragHandler: _this.props.dragHandler, releaseHandler: _this.props.releaseHandler }, _this.cells(rowIndex))) || React.createElement("tr", null, _this.cells(rowIndex));
        });
    };
    return HeaderRow;
}(React.Component));
