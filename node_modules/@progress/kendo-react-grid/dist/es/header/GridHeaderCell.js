...
var GridHeaderCell = /** @class */ (function (_super) {
    ...
    GridHeaderCell.prototype.render = function () {
        var defaultRendering = this.props.onClick && (React.createElement("a", { className: "k-link", href: "#", onClick: this.props.onClick },
            this.props.title || this.props.field || '',
            this.props.children)) || this.props.title || this.props.field || '';
