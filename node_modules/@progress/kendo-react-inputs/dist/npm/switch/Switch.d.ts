...
/**
 * Represents the props of the [Kendo UI Switch component for React]({% slug overview_switch %}).
 */
...
/**
 * Represents the [Kendo UI Switch component for React]({% slug overview_switch%}).
 */
