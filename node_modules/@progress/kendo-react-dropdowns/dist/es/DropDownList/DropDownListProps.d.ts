...
/**
 * Represents the props of the [Kendo UI DropDownList component for React]({% slug overview_dropdownlist %}).
 */
export interface DropDownListProps extends FormComponentProps {
    ...
    /**
     * Specifies the `name` property of the selected DOM element.
     */
    name?: string;
}
