...
/**
 * Represents the [Kendo UI DropDownList component for React]({% slug overview_dropdownlist %}).
 *
 * @example
 * ```jsx
...
var DropDownList = /** @class */ (function (_super) {
    ...
    function DropDownList() {
        ...
        _this.renderDropDownWrapper = function () {
            ...
            return (React.createElement("span", { ref: function (el) { return _this.base.wrapper = el; }, role: 'listbox', tabIndex: disabled ? undefined : tabIndex, className: kendo_react_common_1.classNames('k-dropdown-wrap', _this.props.className, {
                ...
                React.createElement("select", { name: _this.props.name, ref: function (el) { _this._select = el; }, tabIndex: -1, style: { opacity: 0, width: 1, border: 0, zIndex: -1, position: 'absolute', left: '50%' } },
     ...
     * @hidden
     */
    DropDownList.propTypes = __assign({ delay: PropTypes.number, ignoreCase: PropTypes.bool, iconClassName: PropTypes.string, defaultItem: PropTypes.any, valueRender: PropTypes.func, validationMessage: PropTypes.string, required: PropTypes.bool }, DropDownBase_1.default.propTypes);
    /**
     * @hidden
     */
